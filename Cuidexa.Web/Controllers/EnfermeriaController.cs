...
public class EnfermeriaController : Controller
{
    ...
    public EnfermeriaController(IEnfermeriaService enfermeria, IEventoDistribucionService eventos, ITurnoService turnos, IVacacionService vacaciones, IGrupoNotificacionService grupos, CuidexaDbContext db)
    {
